...
<task type="auto">
  <name>Task 3: Create document_search tests</name>
...
```
  ...
  <verify>
```bash
cd backend && python -m pytest tests/unit/services/test_document_search.py -v
```
All tests pass.
  </verify>
  <done>6 tests pass for document_search service</done>
</task>

<task type="auto">
  <name>Task 4: Create encryption tests</name>
  <files>backend/tests/unit/services/test_encryption.py</files>
  <action>
...
```
  ...
  <verify>
```bash
cd backend && python -m pytest tests/unit/services/test_encryption.py -v
```
All tests pass.
  </verify>
  <done>10 tests pass for encryption service</done>
</task>
