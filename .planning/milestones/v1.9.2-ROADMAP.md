...
- D-34-01: Preserve _streamingText on error (PITFALL-01)
- D-34-02: Use AlertDialog for file size error (allows retry action)
- D-35-01: Use API costPercentage (PITFALL-04)
- D-35-02: Mode validation at API level, not DB constraint
- D-35-03: ActionChip for mode badge (icon + label)
- D-36-01: Track documents at backend search time (PITFALL-05)
- D-36-02: ArtifactType enum uses exact backend snake_case
- D-36-03: Collapsed artifact cards by default (PITFALL-08)
- D-36-04: Bottom sheet preview for project-less threads

**Issues Resolved:**

- Infinite artifact generation loop (max_turns=3 limit)
- PDF export error message improvement
