...
| Default provider | anthropic (Claude) | Maintains existing behavior as default |
| SharedPreferences key | defaultLlmProvider | Persists user's provider preference |
| Provider list | anthropic, google, deepseek | Three providers for v1.8 |
| Thinking/reasoning | Hidden from user | Both Gemini thinking and DeepSeek reasoning_content not exposed |
