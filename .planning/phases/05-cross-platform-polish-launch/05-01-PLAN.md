...
<objective>
Add professional loading states and error handling to prevent blank screens and provide graceful failure recovery across all user-facing screens.

Purpose: Eliminate jarring blank screens during data loads and provide clear feedback when operations fail, ensuring professional UX that meets production quality standards.

Output: All list screens display skeleton loaders during fetch, all error scenarios show Material 3 error UI with recovery actions, global error handlers prevent crashes.
</objective>
...
<task type="auto">
  <name>Add skeleton loaders to all list screens</name>
  <files>
    frontend/pubspec.yaml
    frontend/lib/screens/projects/project_list_screen.dart
    frontend/lib/screens/documents/document_list_screen.dart
